...
sleep 120
mkdir -p /var/tmp/code-to-prod-demo
git clone git@github.com:florianmoss/reverse-words.git /var/tmp/code-to-prod-demo/reverse-words
git clone git@github.com:florianmoss/reverse-words-cicd.git /var/tmp/code-to-prod-demo/reverse-words-cicd
